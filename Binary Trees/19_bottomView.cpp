...
vector<int> topView(Node *root)
    {
        ...
        while(!q.empty()){
            ...
            /********* Note the difference is that in bottom view we always overwrite when we get new node for a particular horizontal distance. ***********/

            topNode[hd] = frontNode -> data;       // add the new node and its hoizontal distance
